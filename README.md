...
## Принцип работы:
### Для эффективной работы с древовидной структурой используется LTree + GIST + декомпозиция для эффективного выполнения запросов, что позволяет оч быстро проходиться по дереву(тестил на 100к юзеров)

![TREE](assets/ltree.png)

___

## Локальный запуск приложения(только инфа)
